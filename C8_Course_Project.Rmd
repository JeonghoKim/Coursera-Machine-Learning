...
should create a report describing how you built your model, how you used cross validation, what
you think the expected out of sample error is, and why you made the choices you did. You will also
...
partitioning the Data set into two
```{r echo=TRUE}
...
# Remove thefirst column of the myTraining data set
...
##  Predicition with Generalized Boosted Regression
...
Random Forests gave an Accuracy in the myTesting dataset of 99.89%, which was more accurate that
what I got from the Decision Trees or GBM. The expected out-of-sample error is 100-99.89 = 0.11%.
